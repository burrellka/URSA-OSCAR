...
2. Bump the image version env vars in your compose file:
   ```yaml
   URSA_OSCAR_IMAGE_VERSION: 0.10.0     # was 0.9.1
   URSA_OSCAR_WEB_IMAGE_VERSION: 0.10.0
   ```
...
6. Hit the Daily View to confirm the UI is back up
